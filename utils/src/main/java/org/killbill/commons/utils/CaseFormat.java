...
/**
 * Verbatim copy of guava's com.google.common.base.CaseFormat (v.31.0.1).
 * See <a href="https://github.com/killbill/killbill/issues/1615">More</a>.
 *
 * <p>Utility class for converting between various ASCII case formats. Behavior is undefined for
 * non-ASCII input.
 *
 * @author Mike Bostock
 * @since 1.0
