...
public class RouteForwardingTest {
  ...
  public void consumes() throws Exception {
    ...
    new MockUnit(Route.class)
        .expect(unit -> {
          ...
          when(route.consumes()).thenReturn(consumes);
        })
        .run(unit -> {
  ...
  public void produces() throws Exception {
    ...
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.produces()).thenReturn(produces);
        })
        .run(unit -> {
  ...
  public void name() throws Exception {
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.name()).thenReturn("xXX");
        })
        .run(unit -> {
  ...
  public void path() throws Exception {
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.path()).thenReturn("/xXX");
        })
        .run(unit -> {
  ...
  public void attributes() throws Exception {
    ...
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.attributes()).thenReturn(attributes);
        })
        .run(unit -> {
  ...
  public void attr() throws Exception {
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.attr("foo")).thenReturn("bar");
        })
        .run(unit -> {
  ...
  public void renderer() throws Exception {
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.renderer()).thenReturn("text");
        })
        .run(unit -> {
  ...
  public void verb() throws Exception {
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.method()).thenReturn("OPTIONS");
        })
        .run(unit -> {
  ...
  public void vars() throws Exception {
    ...
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.vars()).thenReturn(vars);
        })
        .run(unit -> {
  ...
  public void glob() throws Exception {
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.glob()).thenReturn(true);
        })
        .run(unit -> {
  ...
  public void reverseMap() throws Exception {
    ...
    new MockUnit(Route.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.reverse(vars)).thenReturn("/");
        })
        .run(unit -> {
  ...
  public void source() throws Exception {
    new MockUnit(Route.class, Route.Source.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.source()).thenReturn(unit.get(Route.Source.class));
        })
        .run(unit -> {
  ...
  public void printWithIndent() throws Exception {
    new MockUnit(Route.class, Route.Source.class)
        .expect(unit -> {
          Route route = unit.get(Route.class);
          when(route.print(6)).thenReturn("x");
        })
        .run(unit -> {
          assertEquals("x",
