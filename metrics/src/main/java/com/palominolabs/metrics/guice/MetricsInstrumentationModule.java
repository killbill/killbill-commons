...
public class MetricsInstrumentationModule extends AbstractModule {
     ...
     */
    private MetricsInstrumentationModule(final MetricRegistry metricRegistry, final Matcher<? super TypeLiteral<?>> matcher,
                                         final MetricNamer metricNamer, final AnnotationResolver annotationResolver) {
